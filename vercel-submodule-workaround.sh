...
MAIN_REPO=https://github.com/sjisntsuperman/personal-site.git
SUBMODULE_REPO=https://gitlab.com/rmaguiar/hugo-theme-color-your-world.git

# the path of the submodule in .gitmodules
SUBMODULE_PATH=themes/color-your-world

# the reference of the submodule in .gitmodules (usually the path)
SUBMODULE_REF=themes/color-your-world
